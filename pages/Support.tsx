...
import { ActionLog, UserRole, Backup } from '../types';
import { 
  LifeBuoy, 
  MessageSquare, 
  Mail, 
  ...
  return (
    <div className="space-y-8 pb-24 md:pb-8 max-w-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-1">
        {[{ id: 'support', label: 'Canais de Ajuda', icon: MessageSquare, color: 'green' }, { id: 'backup', label: 'Segurança & Backup', icon: Database, color: 'blue' }].map(item => (
